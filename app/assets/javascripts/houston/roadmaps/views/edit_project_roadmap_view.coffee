class Roadmaps.EditProjectRoadmapView extends Neat.CollectionEditor
  resource: 'milestones'
  viewPath: 'houston/roadmaps/milestones'
  sortedBy: 'startDate'
  sortOrder: 'asc'
  pageSize: Infinity
  ...
  initialize: ->
    ...
    @roadmap = new Roadmaps.EditRoadmapView @milestones,
