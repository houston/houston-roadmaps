class Roadmap.ProjectRoadmapHistoryView extends Backbone.View
  ...
  initialize: ->
    ...
    @visibleMilestones = new Roadmap.Milestones()
    @updateRoadmap()

    @roadmap = new Roadmap.RoadmapView(@visibleMilestones, @options)
    @template = HandlebarsTemplates['houston/roadmap/history']
    super
